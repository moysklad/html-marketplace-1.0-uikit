    ...
    !function n(t, e) {
      if (!t.compiled) {
        if (t.compiled = !0, t.k = t.k || t.bK, t.k) {
          ...
          var a = {};
          "string" == typeof t.k ? _r("keyword", t.k) : u(t.k).forEach(function (e) {
            _r(e, t.k[e]);
          }), t.k = a;
        }
...
(function () {
  ...
  Array.prototype.forEach.call(tabs, function (tab) {
    var buttons = tab.querySelectorAll('.js-tabs-button');
    var items = tab.querySelectorAll('.js-tabs-item');
...
(function () {
  ...
  Array.prototype.forEach.call(examples, function (example) {
    var markup = example.querySelector('.js-example-markup').innerHTML;
    var text = example.querySelector('.js-example-text');
